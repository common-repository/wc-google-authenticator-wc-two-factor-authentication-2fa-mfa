...
Donate link: https://totalwpcare.com/donate/
...
Simple & Easy Google Authenticator (2FA) setup.

== Description ==

Have a completely Secure login to your Woocommerce website using this FREE, Simple & very easy to setup plugin. It provides Google authenticator (2FA, MFA) whenever login to your woocommerce website ensuring no unauthorised access to your website.


<h4>Prevent Account Sharing</h4>
Many platforms want to prevent sharing of account between the users. This can be done using WC Google Authenticator Two factor plugin.

<h4>Plugin Features</h4>
* Simplified & easy user interface.
* Google Authenticator (2FA) for **Unlimited Users** forever FREE!

Check all the features here: <a href="https://totalwpcare.com/" target="_blank">TotalWPCare Website</a>


Customized solutions and Active support is available. Email us at info@totalwpcare.com or Call/Whatsapp/Telegram/Signal us at +91 8358995599.
